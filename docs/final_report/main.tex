...
\begin{tabular}{|l|l|l|}
\hline
\textbf{} & \textbf{Java} & \textbf{Matlab}\\
\hline
Matrix Size & 1024x1 & 1024x1\\
\hline
Avg. Execution Time (sec) & 2.564 & 0.166\\
\hline
Min. Execution Time (sec) & 2.022 & 0.154\\
\hline
Max. Execution Time (sec) & 3.016 & 0.223\\
\hline
\end{tabular}
\end{table}
