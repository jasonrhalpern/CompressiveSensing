...
November 22nd - Attempt to use either the Android simulator or sensor networks and collect signals from these devices and then use our distributed algorithm to recover these signals.

December 13th -Ð Submit final report and other deliverables. There will also be a scheduled presentation or demo. We will implement these algorithms with Android devices or wireless sensor networks to demonstrate how we can use these techniques to send less data over a wireless channel and subsequently decompress the signals over the cloud. We will submit a plan in order to demo at the ISPN 2012 Demo Session to show the progress we have made in parallelizing CS algorithms.
