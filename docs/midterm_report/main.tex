...
\section{Sources}
1. Emmanuel J. Candès and Michael B. Wakin, \emph{An Introduction to Compressive Sampling}. IEEE Signal Processing Magazine. March 2008.\newline
2. D. Needell and J. A. Tropp. \emph{CoSaMP: Iterative Signal Recovery From Incomplete and Inaccurate Samples}. Appl. Comput. Harmon. Anal., Vol. 26, pp. 301-321, 2008.\newline
3. Rice University DSP: Model-based Compressive Sensing Toolbox v1.1. http://dsp.rice.edu/software/model-based-compressive-sensing-toolbox
